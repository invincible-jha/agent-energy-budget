"""Plugin registry for agent-energy-budget.
...
"agent_energy_budget.plugins" group.
...
class PluginRegistry(Generic[T]):
    ...
    def load_entrypoints(self, group: str) -> None:
        ...
        ----------
        group:
            The entry-point group name, e.g. "agent_energy_budget.plugins".
        ...
        Then at runtime::
            ...
            registry.load_entrypoints("agent_energy_budget.plugins")
        """
