# Contributing to agent-energy-budget

Thank you for contributing to agent-energy-budget, part of the AumOS portfolio.
...
```bash
git clone https://github.com/aumos-ai/agent-energy-budget.git
cd agent-energy-budget
pip install -e ".[dev]"
```
